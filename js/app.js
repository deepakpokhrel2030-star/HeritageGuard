  ...
  function renderDetBody(a){
    ...
    if(a.type==='video'){
      ...
      media=`<div class="det-ph" style="flex-direction:column;gap:1rem">
        ...
        <a href="${a.thumbnail}" target="_blank" rel="noopener" class="btn-primary" style="text-decoration:none;padding:.6rem 1.4rem;border-radius:8px;background:var(--au);color:#fff;font-weight:600">
          📂 Open Document
        </a>
        <a href="${a.thumbnail}" download class="btn-outline" style="text-decoration:none;padding:.6rem 1.4rem;border-radius:8px">
          ↓ Download
        </a>
      </div>`
